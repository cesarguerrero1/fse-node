...
class FollowDao {
    ...
    */
    findPeopleIFollow(uid) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield FollowModel_1.default.find({ userFollowing: uid }).populate("userFollowed", { _id: 1, username: 1, firstName: 1, lastName: 1 }).exec();
        });
    }
    /**
    ...
    */
    findPeopleWhoFollowMe(uid) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield FollowModel_1.default.find({ userFollwowed: uid }).populate("userFollowing", { _id: 1, username: 1, firstName: 1, lastName: 1 }).exec();
        });
    }
    /**
