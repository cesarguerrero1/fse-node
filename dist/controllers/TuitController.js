    ...
    constructor(app, tuitDao) {
        ...
        this.findTuitsByUser = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (req.params.uid === "me" && profile) {
                userId = profile._id;
                const userTuits = yield this.tuitDao.findTuitsByUser(userId);
         ...
         * as we will likely just programatically display the content on the screen
         */
        this.createTuitByUser = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (req.params.uid === "me" && profile) {
                userId = profile._id;
                const newTuit = yield this.tuitDao.createTuitByUser(userId, Object.assign(Object.assign({}, req.body), { postedBy: userId }));
